...
public:
  ...
  virtual std::optional<Action>
  StringToActionSafe(Player player, const std::string &action_str) const;

  std::optional<Action>
  StringToActionSafe(const std::string &action_str) const {
    return StringToActionSafe(CurrentPlayer(), action_str);
  }
